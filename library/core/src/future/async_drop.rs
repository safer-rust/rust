...
/// # Safety
///
/// * The pointer `_to_drop` must be valid for both reads and writes, not only for the duration of this function call, but also until the returned future has completed.
